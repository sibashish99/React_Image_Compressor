...
export default class imageCompressor extends React.Component {
  constructor() {
    ...
    this.state = {
      compressedLink:
        "http://www.pngall.com/wp-content/uploads/2/Download-Button-PNG-Image-File.png",
      originalImage: "",
      originalLink: "",
      clicked: false,
      uploadImage: false
    ...
    return (
      <div className="m-5">
        <div className="text-light text-center">
          ...
          <h3>2. Click On Compress Button</h3>
          ...
          <div className="col-xl-4 col-lg-4 col-md-12 col-sm-12">
            {this.state.uploadImage ? (
              ...
              <Card.Img
                className="ht"
                variant="top"
                src="http://www.pngall.com/wp-content/uploads/2/Upload-PNG-Free-Image.png"
              ></Card.Img>
            )}
